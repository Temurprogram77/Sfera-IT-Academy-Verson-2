...
const monthlyGrades = [
  { week: "Hafta 1", score: 8, group: "Fullstack 1", course: "React", teacher: "Ali aka", bg: triangle },
  { week: "Hafta 2", score: 6, group: "Fullstack 1", course: "Node.js", teacher: "Sardor aka", bg: circle },
  { week: "Hafta 3", score: 9, group: "Fullstack 1", course: "JavaScript", teacher: "Madina opa", bg: triangle },
  { week: "Hafta 4", score: 7, group: "Fullstack 1", course: "HTML/CSS", teacher: "Aziza opa", bg: star },
];
  ...
  return (
    <div className="rounded-3xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-white/[0.03] space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100">Oylik baholarim</h3>
          <p className="text-xs text-gray-500 font-medium">O‘tgan oy baholari (0–10 ball)</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        {monthlyGrades.map((item, idx) => (
          ...
          >
            <img className="absolute bottom-0 right-0" src={item.bg} alt={item.week} />
